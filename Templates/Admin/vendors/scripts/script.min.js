...
jQuery(window).on("load", function () {
    ...
    jQuery(window).on("load resize", function () {
        $(".customscroll").mCustomScrollbar({ theme: "dark-2", scrollInertia: 300, autoExpandScrollbar: !0, advanced: { autoExpandHorizontalScroll: !0 } });
    }),
    jQuery(document).ready(function () {
        ...
        jQuery(".bg_img").each(function (e, t) {
            ...
            jQuery(this).hide(),
                jQuery(this)
                    .parent()
                    .css({ background: "url(" + o.attr("src") + ") no-repeat center center" });
        }),
        ...
        $(document).on("touchstart click", function (e) {
            ...
            $(".date-picker").datepicker({ language: "en", autoClose: !0, dateFormat: "dd MM yyyy" }),
            $(".datetimepicker").datepicker({ timepicker: !0, language: "en", autoClose: !0, dateFormat: "dd MM yyyy" }),
            $(".datetimepicker-range").datepicker({ language: "en", range: !0, multipleDates: !0, multipleDatesSeparator: " - " }),
            $(".month-picker").datepicker({ language: "en", minView: "months", view: "months", autoClose: !0, dateFormat: "MM yyyy" }),
            $(".time-picker").timeDropper({ mousewheel: !0, meridians: !0, init_animation: "dropdown", setCurrentTime: !1 }),
    ...
    (function (a) {
        a.fn.vmenuModule = function (e) {
            ...
            (o = (t = a(this)).find("ul").parent("li").children("a")).attr("data-option", "off"),
